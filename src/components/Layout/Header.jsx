...
const headerData = {
  ...
  social: {
    facebook: "https://facebook.com/sifimy",
    twitter: "https://twitter.com/thecipstar",
    instagram: "https://www.instagram.com/",
    youtue: "https://www.youtube.com/@BrokenHeartSlayer/",
    dribbble: "https://dribbble.com/sifimy",
  },
};
        ...
        <div className="header-inner d-flex align-items-start flex-column">
          ...
          <div className="footer mt-auto">
            ...
            <span className="copyright">
              &copy; {new Date().getFullYear()} Sifi Template
            </span>
          </div>
        </div>
      </header>
