...
function BlogDetails(props) {
  ...
  const [isUserLoggedIn, setIsUserLoggedIn] = useState(false); // State to keep track of user login status
  ...
  const disqusShortname = "https-sifi-my"; //found in your Disqus.com dashboard
  const disqusConfig = {
    url: "https://sifi.my", //Homepage link of this site.
    identifier: blogId,
    title: blogFile,
  };
  ...
  const handleDisqusReady = () => {
    if (window.DISQUS && window.DISQUS.isUserLoggedIn()) {
